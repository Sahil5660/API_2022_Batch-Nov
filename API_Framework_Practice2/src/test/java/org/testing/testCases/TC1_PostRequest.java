...
public class TC1_PostRequest {
	...
	String bodyData=HandleJSONFile.LoadJSONFile("../API_Framework_Practice2/src/main/java/org/testing/Resources/InputPayLoad.json");
	
   
	String replacedData=JSONReplacement.replaceJsonData(bodyData, "id", RandomData.generateRandomData());
	HTTPMethods http=new HTTPMethods(pr);
	Response res=http.PostRequest(replacedData, "QA_URI_Environment"); 
	idValue=JsonParsingUsingJsonServer.ExtractionId(res, "id");
	}
